...
namespace ExcelHelper.TypeConversion
{
    ...
    {
        private static readonly ConcurrentDictionary<Type, object> _converters = new ConcurrentDictionary<Type, object>();
        ...
        {
            var converter = _converters.GetOrAdd(typeof(T), _ => CreateConverter(typeof(T)));
